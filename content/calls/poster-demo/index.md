...
Contributions should be clearly related to the Semantic Web or have an impact in the field of semantics. ESWC adheres to the principles and guidelines stated in the [ACM Policy on Authorship](https://www.acm.org/publications/policies/new-acm-policy-on-authorship) specifically about “Criteria for Authorship” regarding the use of Generative AI technologies for authoring papers. 
...
- Submissions must be in PDF. Springer Publications expects the LaTeX source for the camera ready.
- Submissions must be formatted in the style of the Springer Publications format for Lecture Notes in Computer Science (LNCS). For details on the LNCS style, see [Springer’s Author Instructions](https://www.springer.com/us/computer-science/lncs/conference-proceedings-guidelines).
...
- Submissions must clearly demonstrate relevance to the Semantic Web and the topics of interest of ESWC 2026. 
...
- Submission is done through EasyChair [(https://easychair.org/my/conference?conf=eswc2026)](https://easychair.org/my/conference?conf=eswc2026). When logging in, select the “Posters and Demos” track.
...
**Pasquale Lisena**  
EURECOM - France, pasquale.lisena@eurecom.fr 

**Marta Sabou**  
Vienna University Economics and Business (WU) - Austria, marta.sabou@wu.ac.at 
